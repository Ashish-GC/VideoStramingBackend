...
const getAllVideos = asyncHandler(async (req, res) => {
    let { page = 1, limit = 10, query, sortBy="views", sortType="desc", userId } = req.query
    ...
    // if userId
        ...
        return res.status(200).json(new ApiResponse(200,filterVideo,"feteched videos by query"));
...
const updateVideo = asyncHandler(async (req, res) => {
    ...
    const thumbnailFilePath = req.file?.path;
        ...
        if(thumbnailFilePath){
            if(!thumbnail){throw new ApiError(400,"error while uploading in cloudinary")}
        }
...
const deleteVideo = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200,video.title,"video deleted"))
...
const togglePublishStatus = asyncHandler(async (req, res) => {
    ...
    if(!video){
     ...
     const toggleStatus= video.isPublished;
      ...
      return res.status(200).json(new ApiResponse(200,video.isPublished,"publish status changed"))
})
